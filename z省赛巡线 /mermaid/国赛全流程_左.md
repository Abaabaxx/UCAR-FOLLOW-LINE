...
stateDiagram-v2
    ...
    DRIVE_IN_CIRCLE: 5-环岛
    ROTATE_TO_FACE_EXIT_BOARD: 6-旋转正对出口板
    FOLLOW_LEFT_WITH_AVOIDANCE: 7-带避障循线
    AVOIDANCE_MANEUVER: 8-执行避障机动
    FOLLOW_TO_FINISH: 9-最终冲刺循线
    FINAL_STOP: 10-任务结束并停止
    ...
    DRIVE_IN_CIRCLE --> ROTATE_TO_FACE_EXIT_BOARD: 检测到左侧出口板
