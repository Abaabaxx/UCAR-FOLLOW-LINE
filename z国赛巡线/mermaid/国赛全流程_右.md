...
stateDiagram-v2
    ...
    DRIVE_IN_CIRCLE: 4-环岛 (逆时针)
    ROTATE_TO_FACE_EXIT_BOARD: 5-旋转正对出口板
    FOLLOW_RIGHT_WITH_AVOIDANCE: 6-带避障循线
    AVOIDANCE_MANEUVER: 7-执行避障机动
    FOLLOW_TO_FINISH: 8-最终冲刺循线
    FINAL_STOP: 9-任务结束并停止
    ...
    DRIVE_IN_CIRCLE --> ROTATE_TO_FACE_EXIT_BOARD: 检测到右侧出口板
    ROTATE_TO_FACE_EXIT_BOARD --> FOLLOW_RIGHT_WITH_AVOIDANCE: 已正对出口板
    FOLLOW_RIGHT_WITH_AVOIDANCE --> AVOIDANCE_MANEUVER: 检测到障碍物
